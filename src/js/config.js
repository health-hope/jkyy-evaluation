...
var config = {
    ...
    /****存在用户信息处理 ******
     * 1.访问地址：/evaluting/views/basicInfo.html?evaluationCode=FPFXPC&gender=1&userName=啊&birthday=1990-01-01
     * 2. 参数说明：
     *   a) evaluationCode 评测编码 必须
     *   b）gender 性别 1 男 2 女  非必需
     *   c）userName 用户姓名 非必需
     *   d）birthday 出生日期  格式 yyyy-MM-dd  非必需
     *   e) height 身高
     *   f）weight
     */
}